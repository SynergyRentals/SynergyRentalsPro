...
import { Menu, Search, Notifications, Person, Settings, Logout, AutoAwesome } from "@mui/icons-material";
    ...
    <header className="bg-white shadow-sm z-10">
      <div className="flex justify-between items-center px-4 py-2">
        ...
        <div className="flex items-center space-x-3">
          ...
          <Button variant="ghost" size="icon" className="text-[#2C2E3E] relative">
            <Notifications />
            {notificationCount > 0 && (
